...
class CSPResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        self.conv3 = nn.Sequential(*[nn.Conv2d(512, 64 , (3, 3), 1, (1, 1))])
        # self.conv3 = nn.Conv2d(512, 64, kernel_size=1,stride=1,bias=False)
    ...
    def _make_tran(self, base,tran_expansion):
        return nn.Sequential(
            ...
            nn.LeakyReLU(),
            conv3x3(base*2, base*2, stride=1), # Shardul change here - made change to run model in this manner - removed size change changed stride from 2 to 1
            nn.BatchNorm2d(base*2),
            nn.LeakyReLU()
        )
...
if __name__ == "__main__":
    net = csp_resnet50(pretrained=False,num_classes = 10)
    net = net.cuda()
    print(summary(net, (3, 112, 112)))
