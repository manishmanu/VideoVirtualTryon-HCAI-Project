...
save_folder_path="tryon_checkpoints_with_cspnet_background"
...
def train():
    ...
    # save_file_name = os.path.join("tryon_checkpoints_cspnet", "tryon_epoch_res" + str(2300) + "_" + str(5300) + "_"  + ".pth")
